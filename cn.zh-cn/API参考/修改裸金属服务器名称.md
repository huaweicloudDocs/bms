...
<td class="cellrowborder" valign="top" width="52.06520652065206%" headers="mcps1.2.4.1.3 "><p id="p1035212924110"><a name="p1035212924110"></a><a name="p1035212924110"></a>裸金属服务器ID。</p>
...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="38.38383838383838%" headers="mcps1.1.5.1.4 "><p id="p1135415916419"><a name="p1135415916419"></a><a name="p1135415916419"></a>裸金属服务器数据结构。详情请参见<a href="#table7261169194115">表2</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  server字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="38.38383838383838%" headers="mcps1.2.5.1.4 "><p id="p17355898414"><a name="p17355898414"></a><a name="p17355898414"></a>修改后的裸金属服务器名称。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="53.66%" headers="mcps1.1.4.1.3 "><p id="p35621045641"><a name="p35621045641"></a><a name="p35621045641"></a>裸金属服务器信息。详情请参见<a href="#table2736041">表3</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  server字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p17102365"><a name="p17102365"></a><a name="p17102365"></a>裸金属服务器名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p66960113"><a name="p66960113"></a><a name="p66960113"></a>裸金属服务器唯一标识ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p56497743"><a name="p56497743"></a><a name="p56497743"></a>裸金属服务器当前状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p12446183"><a name="p12446183"></a><a name="p12446183"></a>裸金属服务器创建时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p19452465"><a name="p19452465"></a><a name="p19452465"></a>裸金属服务器上一次更新时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p31304760"><a name="p31304760"></a><a name="p31304760"></a>裸金属服务器规格信息。详情请参见<a href="#table16383173">表4</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p11303491"><a name="p11303491"></a><a name="p11303491"></a>裸金属服务器镜像信息。详情请参见<a href="#table1258047620856">表5</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p45008451"><a name="p45008451"></a><a name="p45008451"></a>裸金属服务器所属租户ID，格式为UUID。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p53676003"><a name="p53676003"></a><a name="p53676003"></a>裸金属服务器所属用户ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p4469833"><a name="p4469833"></a><a name="p4469833"></a>裸金属服务器元数据。详情请参见<a href="#table2549048917552">表7</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p36610870"><a name="p36610870"></a><a name="p36610870"></a>裸金属服务器的主机ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p27451543"><a name="p27451543"></a><a name="p27451543"></a>裸金属服务器对应的网络地址信息。详情请参见<a href="#table157019291410">表8</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p0388103581113"><a name="p0388103581113"></a><a name="p0388103581113"></a>裸金属服务器所属安全组列表。详情请参见<a href="#table12204733">表10</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p47217024"><a name="p47217024"></a><a name="p47217024"></a>裸金属服务器相关信息快捷链接。详情请参见<a href="#table66226203">表6</a>。</p>
    </td>
    </tr>
    ...
    <a name="ul1147816353420"></a><a name="ul1147816353420"></a><ul id="ul1147816353420"><li>MANUAL：API使用镜像中的分区方案和文件系统创建裸金属服务器。如果目标flavor磁盘较大，则API不会对剩余磁盘空间进行分区。</li><li>AUTO：API使用与目标flavor磁盘大小相同的单个分区创建裸金属服务器，API会自动调整文件系统以适应整个分区。</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p67398419138"><a name="p67398419138"></a><a name="p67398419138"></a>扩展属性，裸金属服务器所在可用区名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p1373914111319"><a name="p1373914111319"></a><a name="p1373914111319"></a>扩展属性，裸金属服务器宿主机名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p187391441111310"><a name="p187391441111310"></a><a name="p187391441111310"></a>扩展属性，裸金属服务器所在虚拟化主机名。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p3739104114137"><a name="p3739104114137"></a><a name="p3739104114137"></a>扩展属性，裸金属服务器别名。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p11740194181312"><a name="p11740194181312"></a><a name="p11740194181312"></a>扩展属性，裸金属服务器电源状态。例如：</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p14740174191317"><a name="p14740174191317"></a><a name="p14740174191317"></a>扩展属性，裸金属服务器任务状态。例如：</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p18381131419166"><a name="p18381131419166"></a><a name="p18381131419166"></a>扩展属性，裸金属服务器状态。例如：</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p18381514181615"><a name="p18381514181615"></a><a name="p18381514181615"></a>扩展属性，裸金属服务器启动时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p5381101461618"><a name="p5381101461618"></a><a name="p5381101461618"></a>扩展属性，裸金属服务器关闭时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p1381121461615"><a name="p1381121461615"></a><a name="p1381121461615"></a>裸金属服务器挂载的云硬盘信息。详情请参见<a href="#table1848813314487">表11</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p147952185191"><a name="p147952185191"></a><a name="p147952185191"></a>裸金属服务器故障原因。详情请参见<a href="#table12341194102918">表12</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p17462102813214"><a name="p17462102813214"></a><a name="p17462102813214"></a>裸金属服务器的描述信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p9462162814213"><a name="p9462162814213"></a><a name="p9462162814213"></a>裸金属服务器宿主机状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p112241540226"><a name="p112241540226"></a><a name="p112241540226"></a>裸金属服务器的主机名。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p12242416222"><a name="p12242416222"></a><a name="p12242416222"></a>批量创建场景，裸金属服务器的预留ID。</p>
    <p id="p218381772520"><a name="p218381772520"></a><a name="p218381772520"></a>当批量创建裸金属服务器时，这些服务器将拥有相同的reservation_id。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p162241452210"><a name="p162241452210"></a><a name="p162241452210"></a>批量创建场景，裸金属服务器的启动顺序。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p16224745221"><a name="p16224745221"></a><a name="p16224745221"></a>裸金属服务器系统盘的设备名称，例如“/dev/sdb”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p11225244224"><a name="p11225244224"></a><a name="p11225244224"></a>创建裸金属服务器时指定的user_data。取值为base64编码后的结果或空字符串。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p619019189226"><a name="p619019189226"></a><a name="p619019189226"></a>裸金属服务器实例是否为锁定状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="53.08469153084692%" headers="mcps1.2.4.1.3 "><p id="p619021852219"><a name="p619021852219"></a><a name="p619021852219"></a>裸金属服务器标签。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 5**  image字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="52.44%" headers="mcps1.2.4.1.3 "><p id="p1429788720856"><a name="p1429788720856"></a><a name="p1429788720856"></a>裸金属服务器镜像ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="52.44%" headers="mcps1.2.4.1.3 "><p id="p203547420856"><a name="p203547420856"></a><a name="p203547420856"></a>裸金属服务器镜像相关快捷链接信息。详情请参见<a href="#table66226203">表6</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 8**  addresses字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.849999999999994%" headers="mcps1.2.4.1.3 "><p id="p14983124444414"><a name="p14983124444414"></a><a name="p14983124444414"></a>名称是变量，表示裸金属服务器使用的虚拟私有云的ID。</p>
    ...
    **表 10**  security\_groups字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.849999999999994%" headers="mcps1.2.4.1.3 "><a name="ul94164044813"></a><a name="ul94164044813"></a><ul id="ul94164044813"><li>创建裸金属服务器时未指定安全组，该值为default。</li><li>创建裸金属服务器时，需要指定已有安全组的ID（UUID格式）。</li></ul>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 11**  os-extended-volumes:volumes\_attached字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.849999999999994%" headers="mcps1.2.4.1.3 "><p id="p1123561344910"><a name="p1123561344910"></a><a name="p1123561344910"></a>删裸金属服务器时是否一并删除该卷。</p>
