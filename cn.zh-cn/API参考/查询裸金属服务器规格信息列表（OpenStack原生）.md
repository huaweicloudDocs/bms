...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="50.970000000000006%" headers="mcps1.1.4.1.3 "><p id="p60002101"><a name="p60002101"></a><a name="p60002101"></a>裸金属服务器规格列表。详情请参见<a href="#table13194498">表3</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  flavors数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.32%" headers="mcps1.2.4.1.3 "><p id="p56261663"><a name="p56261663"></a><a name="p56261663"></a>裸金属服务器规格ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.32%" headers="mcps1.2.4.1.3 "><p id="p61525259"><a name="p61525259"></a><a name="p61525259"></a>裸金属服务器规格名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.32%" headers="mcps1.2.4.1.3 "><p id="p60827539"><a name="p60827539"></a><a name="p60827539"></a>该裸金属服务器规格对应的CPU核数。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.32%" headers="mcps1.2.4.1.3 "><p id="p154673810349"><a name="p154673810349"></a><a name="p154673810349"></a>该裸金属服务器规格对应的内存大小，单位为MB。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.32%" headers="mcps1.2.4.1.3 "><p id="p19756352"><a name="p19756352"></a><a name="p19756352"></a>该裸金属服务器规格对应要求的磁盘大小，单位为GB。</p>
    </td>
    </tr>
