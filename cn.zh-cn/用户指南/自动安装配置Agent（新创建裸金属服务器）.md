...
[http://obs.myhwclouds.com/telescope/agent/cloudinit\_conf\_template.txt](http://obs.myhwclouds.com/telescope/agent/cloudinit_conf_template.txt)
...
3.  在左侧导航中选择“虚拟私有云”。
    ...
    -   如果当前还未创建任何虚拟私有云，请参考[创建虚拟私有云基本信息及默认子网](https://support.huaweicloud.com/qs-vpc/zh-cn_topic_0030971610.html)进行创建。创建完成后，单击该VPC名称（假设为_vpc-ces\_0330_），进入详情页。
...
4.  展开“高级配置”，配置用户数据注入和委托。
    ...
    **表 2**  参数说明
    ...
    <div class="notice" id="zh-cn_topic_0104704446_note1137810101217"><a name="zh-cn_topic_0104704446_note1137810101217"></a><a name="zh-cn_topic_0104704446_note1137810101217"></a><span class="noticetitle"> 注意： </span><div class="noticebody"><p id="zh-cn_topic_0104704446_p845991015214"><a name="zh-cn_topic_0104704446_p845991015214"></a><a name="zh-cn_topic_0104704446_p845991015214"></a>配置的AccessKey必须在“我的凭证  &gt; 管理访问密钥”列表中，否则将鉴权失败，云监控界面看不到监控数据。</p>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="78%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0104704446_p54593103212"><a name="zh-cn_topic_0104704446_p54593103212"></a><a name="zh-cn_topic_0104704446_p54593103212"></a>区域ID。例如：BMS实例所属区域为“华北-北京一”，则RegionId为“cn-north-1”，其他区域的RegionId详见<a href="http://developer.huaweicloud.com/endpoint.html" target="_blank" rel="noopener noreferrer">http://developer.huaweicloud.com/endpoint.html</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  获取安装包
    ...
    <p id="zh-cn_topic_0104704446_p14804642183611"><a name="zh-cn_topic_0104704446_p14804642183611"></a><a name="zh-cn_topic_0104704446_p14804642183611"></a><a href="http://telescope-cn-south-1.obs.myhwclouds.com/agent/telescope_linux_amd64.tar.gz" target="_blank" rel="noopener noreferrer">http://telescope-cn-south-1.obs.myhwclouds.com/agent/telescope_linux_amd64.tar.gz</a></p>
    ...
    <p id="zh-cn_topic_0104704446_p7804144216369"><a name="zh-cn_topic_0104704446_p7804144216369"></a><a name="zh-cn_topic_0104704446_p7804144216369"></a><a href="http://telescope-cn-east-2.obs.myhwclouds.com/agent/telescope_linux_amd64.tar.gz" target="_blank" rel="noopener noreferrer">http://telescope-cn-east-2.obs.myhwclouds.com/agent/telescope_linux_amd64.tar.gz</a></p>
