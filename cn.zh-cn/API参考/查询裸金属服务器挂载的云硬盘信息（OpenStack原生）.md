...
<td class="cellrowborder" valign="top" width="52.275227522752274%" headers="mcps1.2.4.1.3 "><p id="p32842235"><a name="p32842235"></a><a name="p32842235"></a>裸金属服务器ID。</p>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="48.28%" headers="mcps1.1.4.1.3 "><p id="p15568903"><a name="p15568903"></a><a name="p15568903"></a>裸金属服务器挂载信息列表，详情请参见<a href="#table7886611">表2</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  volumeAttachments字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="48.135186481351866%" headers="mcps1.2.4.1.3 "><p id="p62498284"><a name="p62498284"></a><a name="p62498284"></a>所属裸金属服务器ID。</p>
    </td>
    </tr>
