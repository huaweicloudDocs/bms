...
-   参考[XenServer on BMS](https://support.huaweicloud.com/bestpractice-bms/bms_bp_0301.html)了解实际应用场景。

## 虚拟化<a name="section4622154054213"></a>

裸金属服务器具备再次虚拟化的能力，我们提供了XenServer、VMware、Hyper-V、FusionCompute的部署案例供您参考。

-   [XenServer on BMS](https://support.huaweicloud.com/bestpractice-bms/bms_bp_0301.html)
-   [VMware on BMS](https://support.huaweicloud.com/bestpractice-bms/bms_bp_0201.html)
-   [Hyper-V on BMS](https://support.huaweicloud.com/bestpractice-bms/bms_bp_0401.html)
-   [FusionCompute on BMS](https://support.huaweicloud.com/bestpractice-bms/bms_bp_0501.html)
...
想了解裸金属服务器支持的监控指标，请参阅[支持的监控指标（安装Agent）](支持的监控指标（安装Agent）.md)。
