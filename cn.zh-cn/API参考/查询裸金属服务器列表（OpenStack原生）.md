...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p445791014538"><a name="p445791014538"></a><a name="p445791014538"></a>裸金属服务器上次更新状态的时间戳信息。格式为ISO 8601时间格式，例如：2013-06-09T06:42:18Z。</p>
    </td>
    </tr>
    ...
    <p id="p1870622242917"><a name="p1870622242917"></a><a name="p1870622242917"></a>可以在镜像服务控制台查询，也可以调用“<a href="https://support.huaweicloud.com/api-ims/zh-cn_topic_0060804959.html" target="_blank" rel="noopener noreferrer">查询镜像列表</a>”API获取。</p>
    ...
    <p id="p7741128113511"><a name="p7741128113511"></a><a name="p7741128113511"></a>可以在裸金属服务器控制台查询，也可以调用<a href="查询裸金属服务器规格信息列表（OpenStack原生）.md">查询裸金属服务器规格信息列表（OpenStack原生）</a>API获取。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p842631015536"><a name="p842631015536"></a><a name="p842631015536"></a>裸金属服务器名称，使用模糊匹配的方式查询。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p7441161020531"><a name="p7441161020531"></a><a name="p7441161020531"></a>裸金属服务器状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p345110316275"><a name="p345110316275"></a><a name="p345110316275"></a>每页返回裸金属服务器的条数。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p174601046239"><a name="p174601046239"></a><a name="p174601046239"></a>从marker指定的裸金属服务器ID的下一条数据开始查询。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p123246194714"><a name="p123246194714"></a><a name="p123246194714"></a>查询tag字段中包含该值的裸金属服务器。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p154313328536"><a name="p154313328536"></a><a name="p154313328536"></a>查询tag字段中不包含该值的裸金属服务器，值为标签的Key。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p5551832185311"><a name="p5551832185311"></a><a name="p5551832185311"></a>批量创建裸金属服务器时，指定该预留ID，可以查询同批次创建的裸金属服务器。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="p167133212536"><a name="p167133212536"></a><a name="p167133212536"></a>用于排序的属性，包括uuid（裸金属服务器的uuid）、vm_state（裸金属服务器的状态）、display_name（裸金属服务器名称）、task_state（裸金属服务器任务状态）、power_state（电源状态）、created_at（创建时间）、updated_at（更新时间）、availability_zone（可用区）。可以指定多对sort_key和sort_dir。</p>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="51.42%" headers="mcps1.1.4.1.3 "><p id="p36377578"><a name="p36377578"></a><a name="p36377578"></a>裸金属服务器信息列表。详情请参见<a href="#table11253402">表2</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  servers字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.019999999999996%" headers="mcps1.2.4.1.3 "><p id="p24350086"><a name="p24350086"></a><a name="p24350086"></a>裸金属服务器名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.019999999999996%" headers="mcps1.2.4.1.3 "><p id="p60510987"><a name="p60510987"></a><a name="p60510987"></a>裸金属服务器唯一标识。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.019999999999996%" headers="mcps1.2.4.1.3 "><p id="p52375797"><a name="p52375797"></a><a name="p52375797"></a>裸金属服务器相关快捷链接信息。详情请参见<a href="#table64121649">表3</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
