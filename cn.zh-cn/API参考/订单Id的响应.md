...
-   正常响应要素说明
    ...
    <th class="cellrowborder" valign="top" width="23.59%" id="mcps1.1.4.1.2"><p id="p4051029311151"><a name="p4051029311151"></a><a name="p4051029311151"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="56.55%" id="mcps1.1.4.1.3"><p id="p6010832511151"><a name="p6010832511151"></a><a name="p6010832511151"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row3693617411151"><td class="cellrowborder" valign="top" width="19.86%" headers="mcps1.1.4.1.1 "><p id="p3332124712519"><a name="p3332124712519"></a><a name="p3332124712519"></a>order_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.59%" headers="mcps1.1.4.1.2 "><p id="p813044011151"><a name="p813044011151"></a><a name="p813044011151"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="56.55%" headers="mcps1.1.4.1.3 "><p id="p5458589811151"><a name="p5458589811151"></a><a name="p5458589811151"></a>提交订单成功后返回的订单ID，用户可以使用该ID对订单的处理情况进行查询。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   异常响应要素说明
    ...
    <td class="cellrowborder" valign="top" width="23.69%" headers="mcps1.1.4.1.2 "><p id="p1936686411151"><a name="p1936686411151"></a><a name="p1936686411151"></a>字典数据结构[1]</p>
    </td>
