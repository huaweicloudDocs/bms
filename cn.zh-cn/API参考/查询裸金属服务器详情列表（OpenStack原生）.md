...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p445791014538"><a name="zh-cn_topic_0053158693_p445791014538"></a><a name="zh-cn_topic_0053158693_p445791014538"></a>裸金属服务器上次更新状态的时间戳信息。格式为ISO 8601时间格式，例如：2013-06-09T06:42:18Z。</p>
    </td>
    </tr>
    ...
    <p id="zh-cn_topic_0053158693_p1870622242917"><a name="zh-cn_topic_0053158693_p1870622242917"></a><a name="zh-cn_topic_0053158693_p1870622242917"></a>可以在镜像服务控制台查询，也可以调用“<a href="https://support.huaweicloud.com/api-ims/zh-cn_topic_0060804959.html" target="_blank" rel="noopener noreferrer">查询镜像列表</a>”API获取。</p>
    ...
    <p id="zh-cn_topic_0053158693_p7741128113511"><a name="zh-cn_topic_0053158693_p7741128113511"></a><a name="zh-cn_topic_0053158693_p7741128113511"></a>可以在裸金属服务器控制台查询，也可以调用<a href="查询裸金属服务器规格信息列表（OpenStack原生）.md">查询裸金属服务器规格信息列表（OpenStack原生）</a>API获取。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p842631015536"><a name="zh-cn_topic_0053158693_p842631015536"></a><a name="zh-cn_topic_0053158693_p842631015536"></a>裸金属服务器名称，使用模糊匹配的方式查询。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p7441161020531"><a name="zh-cn_topic_0053158693_p7441161020531"></a><a name="zh-cn_topic_0053158693_p7441161020531"></a>裸金属服务器状态。</p>
    ...
    <a name="zh-cn_topic_0053158693_ul29109448426"></a><a name="zh-cn_topic_0053158693_ul29109448426"></a><ul id="zh-cn_topic_0053158693_ul29109448426"><li>ACTIVE：运行中/正在关机/删除中</li><li>BUILD：创建中</li><li>ERROR：故障</li><li>HARD_REBOOT：强制重启中</li><li>REBOOT：重启中</li><li>SHUTOFF：关机/正在开机/删除中/重建中/重装操作系统中/重装操作系统失败/冻结</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p345110316275"><a name="zh-cn_topic_0053158693_p345110316275"></a><a name="zh-cn_topic_0053158693_p345110316275"></a>每页返回裸金属服务器的条数。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p174601046239"><a name="zh-cn_topic_0053158693_p174601046239"></a><a name="zh-cn_topic_0053158693_p174601046239"></a>从marker指定的裸金属服务器ID的下一条数据开始查询。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p123246194714"><a name="zh-cn_topic_0053158693_p123246194714"></a><a name="zh-cn_topic_0053158693_p123246194714"></a>查询tag字段中包含该值的裸金属服务器。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p154313328536"><a name="zh-cn_topic_0053158693_p154313328536"></a><a name="zh-cn_topic_0053158693_p154313328536"></a>查询tag字段中不包含该值的裸金属服务器，值为标签的Key。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p5551832185311"><a name="zh-cn_topic_0053158693_p5551832185311"></a><a name="zh-cn_topic_0053158693_p5551832185311"></a>批量创建裸金属服务器时，指定该预留ID，可以查询同批次创建的裸金属服务器。</p>
    ...
    <td class="cellrowborder" valign="top" width="41.010000000000005%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0053158693_p167133212536"><a name="zh-cn_topic_0053158693_p167133212536"></a><a name="zh-cn_topic_0053158693_p167133212536"></a>用于排序的属性，包括uuid（裸金属服务器的uuid）、vm_state（裸金属服务器的状态）、display_name（裸金属服务器名称）、task_state（裸金属服务器任务状态）、power_state（电源状态）、created_at（创建时间）、updated_at（更新时间）、availability_zone（可用区）。可以指定多对sort_key和sort_dir。</p>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="49.17%" headers="mcps1.1.4.1.3 "><p id="p24702645"><a name="p24702645"></a><a name="p24702645"></a>裸金属服务器信息列表详情。内容参见<a href="查询裸金属服务器详情（OpenStack原生）.md#table6149040">表2</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
