...
<td class="cellrowborder" valign="top" width="49.67496749674967%" headers="mcps1.2.4.1.3 "><p id="p11568292"><a name="p11568292"></a><a name="p11568292"></a>裸金属服务器ID。</p>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="51.28512851285129%" headers="mcps1.1.4.1.3 "><p id="p36377578"><a name="p36377578"></a><a name="p36377578"></a>裸金属服务器信息。详情请参见<a href="#table6149040">表2</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  server字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p29504734"><a name="p29504734"></a><a name="p29504734"></a>裸金属服务器名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p13044459"><a name="p13044459"></a><a name="p13044459"></a>裸金属服务器唯一标识ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p45265976"><a name="p45265976"></a><a name="p45265976"></a>裸金属服务器当前状态信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p10697636"><a name="p10697636"></a><a name="p10697636"></a>裸金属服务器创建时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p25832538"><a name="p25832538"></a><a name="p25832538"></a>裸金属服务器上一次更新时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p34922074"><a name="p34922074"></a><a name="p34922074"></a>裸金属服务器对应裸金属服务器规格信息。详情请参见<a href="#table19588408">表3</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p65556790"><a name="p65556790"></a><a name="p65556790"></a>裸金属服务器镜像信息。详情请参见<a href="#table1258047620856">表4</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p4443775"><a name="p4443775"></a><a name="p4443775"></a>裸金属服务器所属租户ID，UUID格式。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p65704606"><a name="p65704606"></a><a name="p65704606"></a>裸金属服务器所属用户ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p54418662"><a name="p54418662"></a><a name="p54418662"></a>裸金属服务器元数据。详情请参见<a href="#table2549048917552">表6</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p41463203"><a name="p41463203"></a><a name="p41463203"></a>裸金属服务器对应的主机ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p57420266"><a name="p57420266"></a><a name="p57420266"></a>裸金属服务器对应的网络地址信息。详情请参见<a href="#table3730161">表7</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p29797259165818"><a name="p29797259165818"></a><a name="p29797259165818"></a>裸金属服务器所属安全组列表。详情请参见<a href="#table761507165933">表9</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p31233872"><a name="p31233872"></a><a name="p31233872"></a>裸金属服务器相关快捷链接信息。详情请参见<a href="#table16539321">表5</a>。</p>
    </td>
    </tr>
    ...
    <a name="ul63811370174827"></a><a name="ul63811370174827"></a><ul id="ul63811370174827"><li>MANUAL：API使用镜像中的分区方案和文件系统创建裸金属服务器。如果目标flavor磁盘较大，则API不会对剩余磁盘空间进行分区。</li><li>AUTO：API使用与目标flavor磁盘大小相同的单个分区创建裸金属服务器，API会自动调整文件系统以适应整个分区。</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p31816494122520"><a name="p31816494122520"></a><a name="p31816494122520"></a>扩展属性，裸金属服务器所在可用区名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p27006529122520"><a name="p27006529122520"></a><a name="p27006529122520"></a>扩展属性，裸金属服务器宿主机名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p40152581122520"><a name="p40152581122520"></a><a name="p40152581122520"></a>扩展属性，裸金属服务器别名。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p27907859122520"><a name="p27907859122520"></a><a name="p27907859122520"></a>扩展属性，裸金属服务器电源状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p10826513122520"><a name="p10826513122520"></a><a name="p10826513122520"></a>扩展属性，裸金属服务器当前的任务状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p66066036122520"><a name="p66066036122520"></a><a name="p66066036122520"></a>扩展属性，裸金属服务器的稳定状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p55319165122520"><a name="p55319165122520"></a><a name="p55319165122520"></a>扩展属性，裸金属服务器启动时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p3371762122520"><a name="p3371762122520"></a><a name="p3371762122520"></a>扩展属性，裸金属服务器删除时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p35960290122520"><a name="p35960290122520"></a><a name="p35960290122520"></a>裸金属服务器挂载的云磁盘信息。详情请参见<a href="#table20591095122442">表10</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p9033688194558"><a name="p9033688194558"></a><a name="p9033688194558"></a>故障原因，如果裸金属服务器为故障状态，则返回该字段。详情请参见<a href="#table48872702194825">表11</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p55603620192944"><a name="p55603620192944"></a><a name="p55603620192944"></a>裸金属服务器宿主机状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p42600570192944"><a name="p42600570192944"></a><a name="p42600570192944"></a>裸金属服务器的主机名。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p20891691192944"><a name="p20891691192944"></a><a name="p20891691192944"></a>批量创建场景，裸金属服务器的预留id。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p7429535192944"><a name="p7429535192944"></a><a name="p7429535192944"></a>批量创建场景，裸金属服务器的启动顺序。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p14273082192944"><a name="p14273082192944"></a><a name="p14273082192944"></a>裸金属服务器系统盘的设备名称，例如“/dev/sda”。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p39593231192944"><a name="p39593231192944"></a><a name="p39593231192944"></a>创建裸金属服务器时指定的user_data，取值为base64编码的结果或空字符串。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p19869683192944"><a name="p19869683192944"></a><a name="p19869683192944"></a>裸金属服务器实例是否为锁定状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="51.07000000000001%" headers="mcps1.2.4.1.3 "><p id="p23937628192944"><a name="p23937628192944"></a><a name="p23937628192944"></a>裸金属服务器标签列表。</p>
    ...
    **表 3**  flavor字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="50.48504850485048%" headers="mcps1.2.4.1.3 "><p id="p20041994"><a name="p20041994"></a><a name="p20041994"></a>裸金属服务器类型ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="50.48504850485048%" headers="mcps1.2.4.1.3 "><p id="p35797372"><a name="p35797372"></a><a name="p35797372"></a>裸金属服务器类型相关快捷链接信息。</p>
    ...
    **表 4**  image字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="50.4%" headers="mcps1.2.4.1.3 "><p id="p1429788720856"><a name="p1429788720856"></a><a name="p1429788720856"></a>裸金属服务器镜像ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="50.4%" headers="mcps1.2.4.1.3 "><p id="p203547420856"><a name="p203547420856"></a><a name="p203547420856"></a>裸金属服务器镜像相关快捷链接信息。详情请参见<a href="#table16539321">表5</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 7**  addresses字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="49.17508249175083%" headers="mcps1.2.4.1.3 "><p id="p2639016112816"><a name="p2639016112816"></a><a name="p2639016112816"></a>名称是变量，表示裸金属服务器使用的虚拟私有云的ID。详情请参见<a href="#table1656029015527">表8</a>。</p>
    ...
    **表 9**  security\_groups字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="48.1951804819518%" headers="mcps1.2.4.1.3 "><a name="ul1907127295026"></a><a name="ul1907127295026"></a><ul id="ul1907127295026"><li>创建裸金属服务器时未指定安全组，该值为default。</li><li>创建裸金属服务器时指定了安全组，该值为安全组名称。</li></ul>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 10**  os-extended-volumes:volumes\_attached字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="48.16481648164816%" headers="mcps1.2.4.1.3 "><p id="p7951369195037"><a name="p7951369195037"></a><a name="p7951369195037"></a>删裸金属服务器时是否一并删除该卷。</p>
